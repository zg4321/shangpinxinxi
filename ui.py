...
from excel_loader import ExcelSourceLoader
...
class DataCheckerImporter:
    ...
    def create_widgets(self):
        ...
        frame_source.grid_columnconfigure(3, weight=1)
    ...
    def show_color_import_preview(self, color_items):
        ...
        color_def_new = [[code, name, ""] for code, name in color_items]
        attr_new = [["(颜色)", f"Y{code}", name] for code, name in color_items]
